...
#所有句子和标签写入文件
def writeFile(sent,posLabel,boundaryLabel,dictLabel,charLabel):
...
import os
from features import speechOfTag,boundary,useDict
...
for file in os.listdir('data'):
    ...
    for i in range(1,101):
        ...
        dictLabel = useDict(sent)
        # print(boundaryLabel)
        charLabel = LabelSent(sent,name)
        writeFile(sent,posLabel,boundaryLabel,dictLabel,charLabel)
        # exit(0)
