...
#进入CRF目录
dir = "C:\code\\bishe\pre_NER\CCKS2017\CNER\8CNER_char_context_postag_pinyin_boduary\CRF"
os.system("cd "+dir)
...
with open("paraResult.txt",'w',encoding='utf-8') as fw:
    for f in range(1,2):
        for c10 in range(10,30,3):
            ...
            #将结果写入文件
            result = ' '.join([str(f),str(c),mfea,mtime,str(p),str(r),str(f1)])
